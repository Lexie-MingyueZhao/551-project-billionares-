                ...
                dbc.Row([
                    dbc.Col([
                        dcc.Graph(id="industry-treemap", figure=create_treemap(),
                                style={'height': '100%', 'width': '100%'})  # ✅ 高度 100%，保证和右侧对齐
                    ], width=8, style={'display': 'flex', 'alignItems': 'stretch'}),  # ✅ 强制对齐
